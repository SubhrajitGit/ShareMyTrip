...
public class RideController {
    ...
    // publisher cancel ride
    @PutMapping("/cancel-published/{publisherRideId}")
    public ResponseEntity<Void> cancelPublishedRide(@PathVariable @Valid Integer publisherRideId) {
    ...
    public ResponseEntity<List<PublisherRideDTO>> getPublisherRidesDetails(@PathVariable @Valid int id) {
    ...
    //publisher cancelled rides by id
    @GetMapping("/publisher/{id}/cancelled")
    public ResponseEntity<List<PublisherRideDTO>> getCancelledRides(@PathVariable @Valid Integer id) {
        List<PublisherRideDTO> rideDetails = rideService.getCompletedRides(id);
        return ResponseEntity.ok(rideDetails);
    }
    ...
    public ResponseEntity<String> setRideStatus(@PathVariable @Valid Integer id) {
    ...
    public ResponseEntity<String> setRideStatusEnd(@PathVariable @Valid Integer id) {
        if (rideService.setRideStatusEnd(id).equals("success"))
            return ResponseEntity.ok("success");
        return ResponseEntity.badRequest().body("Invalid");
    }

    //Publisher's not completed rides
    ...
    //Get passengers for publisher ride
...
//    // passenger can cancel ride
//    @PutMapping("/cancel/{passengerRideId}")
//    public ResponseEntity<Void> cancelRide(@PathVariable @Valid Integer passengerRideId) {
...
public ResponseEntity<Void> cancelRide(@PathVariable Integer passengerRideId) {
    ...
    //Seach rides using from&to locations
    @GetMapping("/filter")
    ...
    public ResponseEntity<List<RideDetailsDTO>> getPassengerRidesDetails(@PathVariable @Valid int passengerId) {
    ...
    //NOT_COMPLETED rides of passenger
    ...
    //Update payment status of publisher
    @PutMapping("/passenger/{passengerRideId}/paid")
    public ResponseEntity<String> setRideStatusPassenger(@PathVariable @Valid Integer passengerRideId) {
