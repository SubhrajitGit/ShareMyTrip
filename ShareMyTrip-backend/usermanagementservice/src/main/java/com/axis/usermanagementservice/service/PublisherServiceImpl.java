...
public class PublisherServiceImpl implements PublisherService {
	...
	public void setStatus(Integer id) {
		String rideMatchingServiceUrl = RIDE_MATCHING_URL + "/publisher/";
	...
	public Publisher getPublisherByEmail(String email) {
		Optional<Publisher> publisher = Optional.ofNullable(publisherRepository.findByEmail(email));
		if(publisher.isEmpty()){
			throw new PublisherNotFoundException("Publisher Not Found In This Email");
		}
		else{
