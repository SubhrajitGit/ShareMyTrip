...
class TransactionDetailsTest {
    ...
    void getPassengerFirstName() {
        ...
        details.setPassengerName(firstName);
        assertEquals(firstName, details.getPassengerName());
    }
    ...
    void getPassengerLastName() {
        TransactionDetails details = new TransactionDetails();
        String lastName = "Doe";
        details.setPassengerName(lastName);
        assertEquals(lastName, details.getPassengerName());
    }
